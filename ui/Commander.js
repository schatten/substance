...
/**
  @class Commander
*/
var Commander = function(component) {
...
Commander.Prototype = function() {
  ...
  */
  this.bind = function(combo, action) {
  ...
  */
  this._getComboKey = function(combo) {
  ...
  */
  this._findAction = function(comboKey) {
  ...
  */
  ...
  this._sequencer = function(inputCombo) {
    var that = this;
    var actions = [];
  ...
  */
  this._resetSequencer = function() {
    for (var combo in this.sequences) delete this.sequences[combo];
  };
  ...
  */
  ...
  this._computeKey = function(combination) {
    var self = this;
    var key = '';
  ...
  */
  this._isModifier = function(key) {
    return key == 'shift' || key == 'ctrl' || key == 'alt' || key == 'meta' || key == 'cmd' || key == 'option';
  };

  /*
    Get key number and returns name of key 
  */
  this._getKeyName = function(key) {
    return Commander._keycodes[key];
  };
};

oo.initClass(Commander);
